...
PROFILE_LEVELS_TABLE = (
    True  # Отображение уровней воды различных обеспеченностей на графике профиля
)
PROFILE_LEVELS_TABLE_LINES = (
    True  # Линии сносок от урезов воды к значению в таблицу уровней
)
...
HYDRAULIC_CURVE_LEVELS = (
    True  # Отрисовка расчётных уровней на графике гидравлической кривой
)
HYDRAULIC_AND_SPEED_CURVE = (
    False  # Отрисовка графика гидравлической кривой с совмещенным графиком скорости
)
...
SPEED_VH_CURVE = False  # Отрисовка графика кривой скоростей от уровня
AREA_CURVE = False  # Отрисовка графика кривой площадей
AREA_FH_CURVE = False  # Отрисовка графика кривой площадей от уровня
QWVH_CURVE = True  # Отрисовка трех графиков (расходов, площади и скорости от уровня)
...
USE_H_INSTEAD_R = False  # Использовать среднюю глубину вместо гидравлического радиуса

# Выбор формулы расчета коэффициента Шези
# Досутпные
SHEZI_TYPE_DEFAULTS = [
    "Манинга",
    "Павловского-Железнякова",
    "Павловского",
    "Железнякова",
    "Гидрорасчеты",
    "Агроскина",
...
COLOR = {
    ...
    "water_reference_line": "navy",  # Линий сноски уреза воды
...
LINE_WIDTH = {
    ...
    "profile_point_line": 0.8,  # Вертикальные линии от точек до подвала
    "profile_footer_divider": 1,  # Линия разделителя подвала
}

TRANSPARENCY = {
    "profile_footer_divider": 0.5,  # Линия разделителя подвала
...
STRING = {"table": "Таблица — ", "figure": "Рисунок — "}
