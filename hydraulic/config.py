...
PROFILE_WET_PERIMETER_NUM = 25  # Количество периметров выше урезов
...
SHEZI_TYPE = "Гидрорасчеты"  # Выбранная формула расчета коэффициента Шези
