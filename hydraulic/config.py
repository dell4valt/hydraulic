...
HYDRAULIC_CURVE = False  # Отрисовка графика гидравлической кривой
HYDRAULIC_CURVE_LEVELS = True  # Отрисовка расчётных уровней на графике гидравлической кривой
HYDRAULIC_AND_SPEED_CURVE = True  # Отрисовка графика гидравлической кривой с совмещенным графиком скорости
...
# 1 — Расчёт обычной воды; 2 — Расчёт водокаменного селевого потока; 3 — Расчёт грязкаменного селевого потока
